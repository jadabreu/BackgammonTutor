...
public class EndGameLayer extends Table {
  ...
  private void _updatePli(int winner) {
    ...
    pl0.add(_l0).expandX();
    pl0.row();
    Texture t = new Texture(Gdx.files.absolute(GnuBackgammon.Instance.nativeFunctions.getDataDirs() + "iconMe.png"));
    ...
    pl1.add(_l1).expandX();
    pl1.row();
    t = new Texture(Gdx.files.absolute(GnuBackgammon.Instance.nativeFunctions.getDataDirs() + "iconOpponent.png"));
    t.setFilter(TextureFilter.Linear, TextureFilter.Linear);
